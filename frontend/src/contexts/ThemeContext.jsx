...
export const DEFAULT_ROLE_PERMISSIONS = {
  ...
  secretary: ['dashboard','residents','certificates','blotter','officials','projects','assets','social','bdrrm','announcements','documents','reports','fin_brgy_id','fin_kidlat','fin_trip','fin_pr','fin_ris','fin_transmittal'],
