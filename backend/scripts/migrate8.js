...
async function run() {
  await pool.query("ALTER TABLE system_settings ADD COLUMN IF NOT EXISTS font_size VARCHAR(10) DEFAULT 'medium'");
  console.log('✓ font_size added to system_settings');
  await pool.end();
}
